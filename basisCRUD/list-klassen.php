    ...
    function deleteStudent(klasId) {
        ...
        $.get('delete-klas.php',
            ...
            function() {
                ...
                window.location.href = 'klassen.php';
...
<table class="table">
    ...
    <?php while($row = $sth->fetch()) { ?>
        ...
        <tr>
            ...
            <td><a class="btn btn-primary" href="update-klas-form.php?id=<?php echo $row["id"]?>">Wijzig</a></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Delete Klas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>Weet je zeker dat je deze Klas wil verwijderen.</p>
            </div>
